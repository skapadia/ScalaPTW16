...
// Grouping by category will give back a Map[Category, List[PurchaseRecord]]
// Take this map and convert the List[PurchaseRecord] to a Double
...
// Grouping by year will give back a Map[Int, List[PurchaseRecord]]
// Take this map and convert the List[PurchaseRecord] to a Doub
